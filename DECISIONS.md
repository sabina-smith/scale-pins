...
- **The brief's "clean and plain" gave way to a minimalist look with motion.** Left third of the screen holds the title and the form (sticky on desktop); the feed is centred in the remaining two thirds. Cards lost their boxes: hairline form fields, light-weight type, a lot of air.
