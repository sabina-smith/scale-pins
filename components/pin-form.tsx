...
const fieldClass =
  "w-full border-0 border-b border-brown-300 bg-transparent px-0 py-2.5 text-sm text-brown-900 placeholder:text-brown-600 transition-colors duration-300 focus:border-brown-900 focus:outline-none";
